    ...
    public partial class UserControlStock : UserControl
    {
        ...
        void LoadData()
        {
            try
            {
                ...
                //
                dgvSTOCK_CellContentClick(null, null);
            }
            catch
            {
        ...
        void LoadDataAVPoS()
        {
            ...
            {
                // push data
                dgvSTOCK.DataSource = dbSTO.GetAvailableProducts();
                // chang size table
                dgvSTOCK.AutoResizeColumns();
        ...
        private void btAvaliableProductonStock_Click(object sender, EventArgs e)
        {
            LoadDataAVPoS();
        }
    }
