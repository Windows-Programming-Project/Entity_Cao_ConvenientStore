...
{
    public partial class UserControlManuafacturer : UserControl
    {
        public UserControlManuafacturer()
        {
            InitializeComponent();
        }
        ...
        void LoadData()
        {
            try
            {
                ...
                //
                dgvMANUAFACTURE_CellContentClick(null, null);
            }
            catch
            {
        ...
        private void dgvMANUAFACTURE_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
